...
angular.module('shoumeApp')
  .controller('AllMomentsCtrl', function ($scope, $timeout, $location, toaster, SubmitResult, RequestAPI, User, History, CloneUtilsCustom) {
    ...
    $scope.getActive = function (moment) {
      return History.getMoment(moment.id);
    };
